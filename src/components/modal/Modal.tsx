            ...
            <div className="mt-2">
              <p className="text-sm text-gray-500 ">
                ...
                <p className="text-justify text-right leading-relaxed">
                  ...
                  طور کلی مهر و ماه و خورشید از عوامل قدرت وصلابت در آئین
                ...
                <p className="text-justify text-right leading-relaxed">
                  همچنان کلمه «شید» به مهنای نور و روشنایی است بهرام علاوه بر
                  ...
                  همین دلیل نام او را بهرام شید گذاردند و این روز یعنی «سه شنبه»
                  را به نام بهرام شید میخوانند
                </p>
                <p>
                  <br />
                  <h2 className=" font-medium leading-6 text-gray-900">
                  ...
                  <p className="text-justify text-right leading-relaxed">
                    ...
                    برابر خورشید تابندگی و جرم دو برابر در استاد محمد ملايري «
                  ...
                  <p className="text-justify text-right leading-relaxed">
                    اورمزد شید در واقع همان اهورا مزدا است و روز پنجشنبه را به
                  ...
                  <p className="text-justify text-right leading-relaxed">
                    ...
                    نزدیکی به خورشید، دومین سیارهٔ زمین‌سان سامانهٔ خورشیدی است
                    که در هر ۲۲۵ روز یکبار به دور خورشید می‌چرخد. مدار زهره،
                  ...
                  <p className="text-justify text-right leading-relaxed">
                    : یکشنبه، روزی است که به ایزد مهریا خورشید نامگذاری شده،
                    ...
                    پیمان‌ها بنا نهاده شده است. این آیین، که به مهر یا خورشید
