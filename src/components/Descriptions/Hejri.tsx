...
const Hejri = () => {
  return (
    <div>
      <h1 className='text-xl font-bold mb-4'>گاه‌شمار هجری خورشیدی</h1>
      <p className='text-lg mb-4'>
        گاه‌شمار هجری خورشیدی، نیز شناخته شده به عنوان تقویم جلالی، بر اساس
        حرکات خورشید است و به طور گسترده‌ای در ایران و افغانستان استفاده می‌شود.
        این تقویم در سال ۱۰۷۹ هجری قمری توسط عمر خیام و دیگر دانشمندان در دوره
      ...
      <ul className='list-disc list-inside mb-4'>
        <li className='text-lg'>
          ...
          >
            ویکی‌پدیا، گاه‌شمار هجری خورشیدی
          </a>
        </li>
      </ul>
    </div>
