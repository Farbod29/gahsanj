  ...
  return (
    <div>
      <p className='text-lg mb-4' dir='rtl' style={{ textAlign: 'justify' }}>
        گاه سنج ایلامی یکی از قدیمی‌ترین گاه سنجهای ایرانی است که در دوران ایلام
        باستان (حدود 3200 تا 539 قبل از میلاد) مورد استفاده قرار می‌گرفت.
        ایلامیان که یکی از تمدن‌های باستانی در جنوب غربی ایران بودند، از این گاه
        سنج برای تعیین تاریخ و زمان استفاده می‌کردند. <br />
      ...
      >
        <li className='text-lg'>
          ...
          باستانی، از یک گاه سنج ماهشیدی (قمری)-خورشیدی استفاده می‌کردند.
        ...
        <li className='text-lg'>
          <strong>کاربرد</strong>: گاه سنج ایلامی به‌ویژه در مراسم دینی، کشاورزی
          و امور دولتی کاربرد داشت. برخی از متون مذهبی و اداری ایلامی که بر روی
          لوح‌های گلی نگاشته شده‌اند، تاریخ‌گذاری شده‌اند که نشان‌دهنده استفاده
          گسترده از این تقویم است.
        </li>
        <li className='text-lg'>
      ...
      <h2 className='text-3xl font-semibold mt-6 mb-2'>اهمیت گاه سنج ایلامی</h2>
      <p className='text-lg mb-4' dir='rtl' style={{ textAlign: 'justify' }}>
        گاه سنج ایلامی نقش مهمی در تاریخ‌نگاری و مطالعه تاریخ باستان ایران دارد.
        با بررسی این گاه سنج، می‌توان به اطلاعات دقیق‌تری درباره رویدادها و
        تحولات تاریخی ایلام و دیگر تمدن‌های همجوار دست یافت.
      </p>
      <ul
        className='list-disc list-inside mb-4'
        dir='rtl'
      ...
      >
        <li className='text-lg'>
          <strong>لوح‌های گلی</strong>: بسیاری از اطلاعات ما درباره گاه سنج
          ایلامی از طریق لوح‌های گلی به دست آمده است.
        </li>
        <li className='text-lg'>
          <strong>آثار باستان‌شناسی</strong>: حفاری‌های باستان‌شناسی در مناطق
          مختلف ایلام باستان، مانند شوش و سیلک، اطلاعات مهمی درباره این گاه سنج
          فراهم کرده‌اند.
        </li>
      </ul>
